...
namespace D3DEngine
{
	...
	public:
		...
		Vert(Vector3f& Pos, Vector2f& TexCoord, Vector3f& Normal) : m_Pos(Pos), m_TexCoord(TexCoord), m_Normal(Normal){/*Empty*/}
		//Destructor
		~Vert();
	...
	private:
		Vector3f m_Pos = Vector3f(0, 0, 0);		//Vert Position
		Vector2f m_TexCoord = Vector2f(0, 0);	//Vert Tex Coord
		Vector3f m_Normal = Vector3f(0, 0, 0);	//Vert Normal
	};
}